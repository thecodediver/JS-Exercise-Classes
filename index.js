...
class Student extends Lambdasian {
  ...
  listSubjects() {
    let string = 'Loving ';
    return string += this.favSubjects.join(', ');
  }
...
class ProjectManager extends Instructor {
  constructor(projManaAttrs) {
    super(projManaAttrs);
    this.gradClassName = projManaAttrs.gradClassName;
    this.favInstructor = projManaAttrs.favInstructor;
  }
